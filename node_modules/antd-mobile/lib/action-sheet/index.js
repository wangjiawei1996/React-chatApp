        ...
        case NORMAL:
            ...
            if (badges && badges.length > 0) {
                badges.forEach(function (element) {
                    if (element.index >= 0) {
                        badgesMap[element.index] = _react2['default'].createElement(_badge2['default'], element);
                    }
                });
            }
            children = _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    normalOptions.map(function (item, index) {
                        ...
                        var bContent = _react2['default'].createElement(
                            'div',
                            itemProps,
                            item
                        );
                        // 仅在设置徽标的情况下修改dom结构
                        if (badgesMap[index]) {
                            bContent = _react2['default'].createElement(
                                'div',
